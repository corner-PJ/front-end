            ...
            <div className={s.page}>
                <div className={s.name}>
                    ...
                    <div className={s.content}>
                        ...
                        <Link className={s.pageButton}>이름 찾으로 가기</Link>   
                    </div>  
                </div>
                <div className={s.decode}>
                    <div className={s.content}>
                        ...
                        <Link className={s.pageButton}>감정 해독하러 가기</Link>       
                    </div>
                ...
                <div className={s.diary}>
                    ...
                    <div className={s.content}>
                        ...
                        <Link className={s.pageButton}>다이어리 작성하러 가기</Link>     
                    </div>      
                </div>
                <div className={s.list}>
                    <div className={s.content}>
                        ...
                        <Link className={s.pageButton}>입양글 보러 가기</Link>   
                    </div>
